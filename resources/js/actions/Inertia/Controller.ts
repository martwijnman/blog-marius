 ...
 * @route '/archive'
 */
const Controller3c5e972c0fe6e2605867a1ef551e98b2 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller3c5e972c0fe6e2605867a1ef551e98b2.url(options),
    method: 'get',
})

Controller3c5e972c0fe6e2605867a1ef551e98b2.definition = {
    methods: ["get","head"],
    url: '/archive',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/archive'
 */
Controller3c5e972c0fe6e2605867a1ef551e98b2.url = (options?: RouteQueryOptions) => {
    return Controller3c5e972c0fe6e2605867a1ef551e98b2.definition.url + queryParams(options)
}
 ...
 * @route '/archive'
 */
Controller3c5e972c0fe6e2605867a1ef551e98b2.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller3c5e972c0fe6e2605867a1ef551e98b2.url(options),
    method: 'get',
})
/**
 ...
 * @route '/archive'
 */
Controller3c5e972c0fe6e2605867a1ef551e98b2.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller3c5e972c0fe6e2605867a1ef551e98b2.url(options),
    method: 'head',
})
 ...
 * @route '/archive'
 */
    const Controller3c5e972c0fe6e2605867a1ef551e98b2Form = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: Controller3c5e972c0fe6e2605867a1ef551e98b2.url(options),
        method: 'get',
    })
 ...
 * @route '/archive'
 */
        Controller3c5e972c0fe6e2605867a1ef551e98b2Form.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: Controller3c5e972c0fe6e2605867a1ef551e98b2.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/archive'
 */
        Controller3c5e972c0fe6e2605867a1ef551e98b2Form.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: Controller3c5e972c0fe6e2605867a1ef551e98b2.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    Controller3c5e972c0fe6e2605867a1ef551e98b2.form = Controller3c5e972c0fe6e2605867a1ef551e98b2Form
    /**
* @see \Inertia\Controller::__invoke
 * @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
 * @route '/dashboard'
 ...
 * @route '/analytics'
 */
const Controller31267796ba3c3b8ba7984e9dd432498b = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller31267796ba3c3b8ba7984e9dd432498b.url(options),
    method: 'get',
})

Controller31267796ba3c3b8ba7984e9dd432498b.definition = {
    methods: ["get","head"],
    url: '/analytics',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/analytics'
 */
Controller31267796ba3c3b8ba7984e9dd432498b.url = (options?: RouteQueryOptions) => {
    return Controller31267796ba3c3b8ba7984e9dd432498b.definition.url + queryParams(options)
}
 ...
 * @route '/analytics'
 */
Controller31267796ba3c3b8ba7984e9dd432498b.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: Controller31267796ba3c3b8ba7984e9dd432498b.url(options),
    method: 'get',
})
/**
 ...
 * @route '/analytics'
 */
Controller31267796ba3c3b8ba7984e9dd432498b.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: Controller31267796ba3c3b8ba7984e9dd432498b.url(options),
    method: 'head',
})
 ...
 * @route '/analytics'
 */
    const Controller31267796ba3c3b8ba7984e9dd432498bForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: Controller31267796ba3c3b8ba7984e9dd432498b.url(options),
        method: 'get',
    })
 ...
 * @route '/analytics'
 */
        Controller31267796ba3c3b8ba7984e9dd432498bForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: Controller31267796ba3c3b8ba7984e9dd432498b.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/analytics'
 */
        Controller31267796ba3c3b8ba7984e9dd432498bForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: Controller31267796ba3c3b8ba7984e9dd432498b.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
    ...
    Controller31267796ba3c3b8ba7984e9dd432498b.form = Controller31267796ba3c3b8ba7984e9dd432498bForm
    /**
* @see \Inertia\Controller::__invoke
 * @see vendor/inertiajs/inertia-laravel/src/Controller.php:13
...
const Controller = {
    ...
    '/archive': Controller3c5e972c0fe6e2605867a1ef551e98b2,
    '/dashboard': Controller42a740574ecbfbac32f8cc353fc32db9,
    '/analytics': Controller31267796ba3c3b8ba7984e9dd432498b,
